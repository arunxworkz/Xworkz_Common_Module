...
<body>
    ...
    <div class="auth-container">
        ...
        <p>${e.defaultMessage}</p>
            ...
            <div class="auth-input-container">
                <input type="text" class="auth-input-field" placeholder="" id="name" name="userName" onchange = "checkName()"/>
            ...
            <div class="auth-input-container">
                <input type="text" class="auth-input-field" placeholder="" id="altEmail" name="altEmail" oninput="validationEmails()"/>
            ...
            <div class="auth-input-container">
                <select id="location" name="location">
                    ...
                    <c:forEach items="${liLocation}" var="location">
                        <option value="${location}">${location}</option>
                    </c:forEach>
                </select>
            </div>

            <button class="auth-submit-button" type = "submit">Sign Up</button>
            <a href="Signin.jsp" class="auth-link">Already Have an Account?</a>
            <a href = "index.jsp" class = "auth-link">Index</a>
        </form>
    </div>
    ...
    function validationEmails() {
        ...
        const alternateEmailInput = document.getElementById("altEmail");
        const message = document.getElementById("message");
        const email = emailInput.value.trim();
        const alternateEmail = alternateEmailInput.value.trim();
        if (email === alternateEmail) {
            message.textContent = "Emails should be different";
        } else {
            message.textContent = "";
        }
    }
    ...
    function checkName(){
        ...
        if(checkValue !== ""){
            ...
            xhttp.open("GET", "http://localhost:8080/Xworkz_Commou_Module_Arun1/checkValue/"+checkValue);
            xhttp.send();
